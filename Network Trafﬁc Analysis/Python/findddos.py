...
lazor targetip=66.211.169.66 message=test_test port=80 method=tcp wait=false random=true star

sudo tcpdump -i eth0 -A 'port 6667' 
...
#python findDDoS.py –p traffic.pcap 
